...
static bool generate(const EmbedOptions& options)
{
    ...
    state.out << "/// This file was generated by cubinhos embed." << std::endl;
    ...
    state.out << std::endl;
    state.out << "#include <cubos/data/embedded_archive.hpp>" << std::endl;
    state.out << std::endl;
    state.out << "using namespace cubos::data;" << std::endl;
    state.out << std::endl;
