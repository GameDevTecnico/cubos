...
namespace cubos::engine
{
    ...
    struct CUBOS_ENGINE_API Inertia
    {
        ...
        /// @param inertiaTensor
        void setFromTensor(const glm::mat3 inertiaTensor);
        ...
        /// diagonal.
        void setWithLocalFrame(const glm::vec3 principalInertia, const glm::quat principalLocalFrame);
    ...
    glm::mat3 CUBOS_ENGINE_API boxShapeInertiaTensor(const float mass, const glm::vec3 dimensions);
    ...
    glm::mat3 CUBOS_ENGINE_API ballShapeInertiaTensor(const float mass, const float radius);
    ...
    glm::mat3 CUBOS_ENGINE_API cylinderShapeInertiaTensor(const float mass, const float height, const float radius);
    ...
    glm::mat3 CUBOS_ENGINE_API capsuleShapeInertiaTensor(const float mass, const float length, const float radius);
    ...
    glm::mat3 CUBOS_ENGINE_API voxelShapeInertiaTensor(const float mass, const VoxelCollisionShape& shape);
