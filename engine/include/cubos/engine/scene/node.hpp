...
namespace cubos::engine
{
    ...
    public:
        ...
        void relateFrom(const core::reflection::Type& type, std::string entity, nlohmann::json data);

        /// @brief Inserts a relation of the given type into the node.
        /// @param type Relation type.
        /// @param entity Path to entity which the relation points to.
        /// @param data Relation data.
        void relateTo(const core::reflection::Type& type, std::string entity, nlohmann::json data);

        /// @brief Removes the relation of the given type from the node.
        /// @param type Relation type.
        /// @param entity Path to entity which the relation originates from.
        void unrelateFrom(const core::reflection::Type& type, std::string entity);

        /// @brief Removes the relation of the given type from the node.
        /// @param type Relation type.
        /// @param entity Path to entity which the relation points to.
        void unrelateTo(const core::reflection::Type& type, std::string entity);

        /// @brief Gets the map of child nodes.
        /// @return Child nodes.
        const std::unordered_map<std::string, SceneNode>& children() const;
