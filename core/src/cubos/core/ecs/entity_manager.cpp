...
template <>
void cubos::core::old::data::serialize<Entity>(Serializer& ser, const Entity& obj, const char* name)
{
...
template <>
void cubos::core::old::data::deserialize<Entity>(Deserializer& des, Entity& obj)
{
