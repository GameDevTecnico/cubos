...
BlueprintBuilder::BlueprintBuilder(old::data::SerializationMap<Entity, std::string>&& map, CommandBuffer& commands)
    : mMap(std::move(map))
    , mCommands(commands)
{
    // Do nothing.
...
{
    old::data::SerializationMap<Entity, std::string> map;
