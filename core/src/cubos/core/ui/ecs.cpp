...
void cubos::core::ui::showWorld(const ecs::World& world, old::data::Context* context)
{
...
void cubos::core::ui::editWorld(ecs::World& world, old::data::Context* serContext, old::data::Context* desContext)
{
