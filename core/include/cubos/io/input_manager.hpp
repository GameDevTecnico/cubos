...
namespace cubos::core::io
{
    ...
    public:
        ...
        static cubos::core::Event<>::ID registerKeyDownCallback(std::function<void(void)> callback, cubos::core::io::Key key);
        ...
        /// @param callback the method that will be called when the key is down
        /// @param key the key to trigger the callback
        template <class T> static void unregisterKeyDownCallback(T* obj, void (T::*callback)(), cubos::core::io::Key key);
        ...
        /// @param mouseButton the mouse button to trigger the callback
        template <class T>
        static void registerMouseButtonDownCallback(T* obj, void (T::*callback)(), cubos::core::io::MouseButton mouseButton);
        ...
        static void unregisterMouseAxisCallback(cubos::core::Event<float>::ID callbackID, cubos::core::io::MouseAxis mouseAxis);
        ...
        /// @param mouseAxis the mouse axis that will trigger the callback
        template <class T>
        static void unregisterMouseAxisCallback(T* obj, void (T::*callback)(float), cubos::core::io::MouseAxis mouseAxis);
    ...
    template <class T> void InputManager::registerKeyDownCallback(T* obj, void (T::*callback)(), cubos::core::io::Key key)
    {
    ...
    template <class T> void InputManager::unregisterKeyDownCallback(T* obj, void (T::*callback)(), cubos::core::io::Key key)
    {
        if (!InputManager::keyDownCallbacks.contains(key))
        {
            return;
    ...
    template <class T>
    void InputManager::registerMouseAxisCallback(T* obj, void (T::*callback)(float), cubos::core::io::MouseAxis mouseAxis)
    {
    ...
    template <class T>
    void InputManager::unregisterMouseAxisCallback(T* obj, void (T::*callback)(float), cubos::core::io::MouseAxis mouseAxis)
    {
        if (!InputManager::mouseAxisCallbacks.contains(mouseAxis))
        {
            return;
