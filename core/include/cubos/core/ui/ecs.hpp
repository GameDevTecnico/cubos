...
namespace cubos::core::ui
{
    ...
    void showWorld(const ecs::World& world, old::data::Context* context = nullptr);
    ...
    void editWorld(ecs::World& world, old::data::Context* serContext = nullptr, old::data::Context* desContext = nullptr);
} // namespace cubos::core::ui
