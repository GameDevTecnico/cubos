...
namespace cubos::core::old::data
{
    ...
    /// `cubos::core::old::data::deserialize` function:
    ///
    ///     struct MyType
    ///     {
    ///         int32_t a;
    ...
    ///     void cubos::core::old::data::deserialize<MyType>(Deserializer& d, MyType& obj)
    ///     {
    ///         d.read(obj.a, "a");
    ///     }
    ///
    ...
    public:
        ...
        /// The `cubos::core::old::data::deserialize` function must be implemented for the given type.
        /// The fail bit is set if the deserialization fails.
