...
namespace cubos::core::data
{
    ...
    protected:
        ...
        virtual std::string getName(std::size_t id) const = 0;

        /// Checks if a file is a directory.
        /// @param id The identifier of the file.
        /// @return True if the file is a directory, false otherwise.
        virtual bool isDirectory(std::size_t id) const = 0;
        ...
        virtual std::size_t getParent(std::size_t id) const = 0;
        ...
        virtual std::size_t getSibling(std::size_t id) const = 0;
        ...
        virtual std::size_t getChild(std::size_t id) const = 0;
