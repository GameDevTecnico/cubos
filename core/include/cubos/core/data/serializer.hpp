...
namespace cubos::core::old::data
{
    ...
    /// `cubos::core::old::data::serialize` function:
    ///
    ///     struct MyType
    ///     {
    ///         int32_t a;
    ...
    ///     void cubos::core::old::data::serialize<MyType>(Serializer& s, const MyType& obj, const char* name)
    ///     {
    ///         s.write(obj.a, "a");
    ///     }
    ///
    ...
    public:
        ...
        /// The `cubos::core::old::data::serialize` function must be implemented for the given type.
