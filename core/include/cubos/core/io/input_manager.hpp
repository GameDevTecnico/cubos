...
namespace cubos::core::io
{
    ...
    public:
        ...
        /// @param key the key to trigger the callback
        /// @return returns the callback ID
        static cubos::core::Event<>::ID registerKeyUpCallback(std::function<void(void)> callback,
                                                              cubos::core::io::Key key);

        /// Unregisters a key up function callback
        /// @param callbackID the ID of the function calback to unregister
        /// @param key the key to unregister the function callback
        static void unregisterKeyUpCallback(cubos::core::Event<>::ID callbackID, cubos::core::io::Key key);
        ...
        /// @param mouseButton the mouse button to trigger the callback
        /// @return returns the callback ID
        static cubos::core::Event<>::ID registerMouseButtonUpCallback(std::function<void(void)> callback,
                                                                      cubos::core::io::MouseButton mouseButton);

        /// Unregisters a mouse button up function callback
        /// @param callbackID the ID of the function calback to unregister
        /// @param mouseButton the key to unregister the function callback
        static void unregisterMouseButtonUpCallback(cubos::core::Event<>::ID callbackID,
                                                    cubos::core::io::MouseButton mouseButton);
        ...
        /// @param mouseButton the mouse button to trigger the callback
        template <class T>
        static void registerMouseButtonUpCallback(T* obj, void (T::*callback)(),
                                                  cubos::core::io::MouseButton mouseButton);
    ...
    template <class T>
    void InputManager::unregisterKeyUpCallback(T* obj, void (T::*callback)(), cubos::core::io::Key key)
    {
        if (!InputManager::keyUpCallbacks.contains(key))
        {
            return;
